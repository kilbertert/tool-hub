...
const relatedTools = [
  { name: "URL 编解码", href: "/converter/url-encode/" },
...
export default function Base64Tool() {
  ...
  const handleConvert = () => {
    ...
    } catch (e) { setError("转换失败: " + (e as Error).message); }
  };

  const handleCopy = () => navigator.clipboard.writeText(output);

  return (
    <ToolPageLayout title="Base64 编解码" description="Base64 编码和解码" breadcrumbs={[{ label: "格式转换", href: "/converter/base64/" }, { label: "Base64" }]} relatedTools={relatedTools}>
